...
// ================= 物理参数定义 =================
// 假设硬件参数：11线编码器，30减速比，65mm轮径，10ms读取一次
#define PI 3.1415926f
#define WHEEL_PULSES_PER_ROUND (11 * 4 * 30) // 转一圈总脉冲数: 1320
#define WHEEL_DIAMETER 0.065f                // 轮子直径: 0.065m
#define DELTA_T 0.01f                        // 采样周期: 10ms (0.01s)

// 定义电机死区 (低于这个值电机不动，强行补偿)
#define DEAD_ZONE 300//占空比1000-55
//PWM限制
#define PWM_LIMIT 7200
